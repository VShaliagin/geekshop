...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0005_auto_20201224_2308'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FR', 'формируется'), ('STP', 'отправлено в обработку'), ('PRD', 'обработано'), ('PD', 'оплачено'), ('RDY', 'готов к выдаче'), ('CNC', 'отменено')], default='FR', max_length=3, verbose_name='статус')),
